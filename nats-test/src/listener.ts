...
stan.on("connect", () => {
    ...
    const subscription = stan.subscribe("ticket:created", "orders-service-queue-group", options);   //subscribe to the ticket:created topic with the orders-service-queue-group
